...
using BASE(dec_int_pk_pplite_domain_t) =
  crab::domains::decoupled_domain<
    crab::domains::apron_asc_dsc_pair<
      ...
      crab::domains::apron_domain<
        ...
        >,
      // Descending domain: PPLite's polyhedra
      crab::domains::apron_domain<
        number_t, region_subdom_varname_t,
        crab::domains::apron_domain_id_t::APRON_PPLITE_FPOLY
        >
      >>;
using dec_int_pk_pplite_domain_t =
  RGN_FUN(ARRAY_FUN(BOOL_NUM(BASE(dec_int_pk_pplite_domain_t))));
} // end namespace clam
